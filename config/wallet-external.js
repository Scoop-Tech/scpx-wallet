...
//
// utxo v2 - insight api rest (obnolete, but backup for non-BB supported types - now only using websockets/insight WS interfaces for Insight)
//
...
//
const btcBlockbookApi = 'https://scp-btcsw.southeastasia.cloudapp.azure.com:10130/api/'
//const btcBlockbookApi = 'https://btc1.trezor.io/api/'

const dashBlockbookApi = 'https://scp-bb-dash01.southeastasia.cloudapp.azure.com:8888/api/'
//const dashBlockbookApi = 'https://scp-btcsw.southeastasia.cloudapp.azure.com:10133/api/'
//const dashBlockbookApi = 'https://dash2.trezor.io/api/' 

const vtcBlockbookApi = 'https://scp-bb-vtc01.southeastasia.cloudapp.azure.com:8888/api/'

const qtumBlockbookApi = 'https://scp-bb-qtum01.southeastasia.cloudapp.azure.com:8888/api/'

const dgbBlockbookApi = 'https://scp-bb-dgb01.southeastasia.cloudapp.azure.com:8888/api/'

const zecBlockbookApi = 'https://scp-bb-zec01.southeastasia.cloudapp.azure.com:8888/api/' //'https://zec1.trezor.io/api/'
const ltcBlockbookApi = 'https://scp-bb-ltc01.southeastasia.cloudapp.azure.com:8888/api/' //'https://ltc1.trezor.io/api/'

const bchabcBlockbookApi = 'https://scp-bb-bch02.southeastasia.cloudapp.azure.com:8888/api/'

//
// dev: etherscan api keys (eth_test ropsten)
//
// const es_apiKeys = [
//     'EG3Q7SGYF2CN7AWZIFFY2UEC8MN7M6B883',
//     '151BISUNJZJ21AAAPXNK93P8JA7B8V5ADR', // scp001
//     'QSYUC3PNMQQ4ZDDGDQ34V6CMB44F69PK3P', // scp001
//     'C6FYY55TQB2EWDX356YHBP3JFH4USP7FXB', // scp001
//     'VXZG583XP3C67R4SCHE25ZJN1UMMK6X3TT', // scp002
//     '4K3BFQE5E4ZTB1FZ3NRSP42FAK4TI96V1H', // scp002
//     '6THSBEU4IAUWKJKRE4E1NN1Y1W9P9Q78S9', // scp002
// ]
...
export const ethHttpProvider = 'https://scp-eth4.southeastasia.cloudapp.azure.com:9545' // geth
...
export const ethFeeOracle_EtherChainOrg = `https://www.etherchain.org/api/gasPriceOracle`
export const btcFeeOracle_BitGo = `https://www.bitgo.com/api/v1/tx/fee?numBlocks=2`
export const ltcFeeOracle_BlockCypher = `https://api.blockcypher.com/v1/ltc/main`
export const dashFeeOracle_BlockCypher = `https://api.blockcypher.com/v1/dash/main`
export const vtcFeeOracle_Blockbook = `https://scp-bb-vtc01.southeastasia.cloudapp.azure.com:8888/api/v2/estimatefee/1`
export const qtumFeeOracle_Blockbook = `https://scp-bb-qtum01.southeastasia.cloudapp.azure.com:8888/api/v2/estimatefee/1`
export const dgbFeeOracle_Blockbook = `https://scp-bb-dgb01.southeastasia.cloudapp.azure.com:8888/api/v2/estimatefee/1`
export const bchabcFeeOracle_Blockbook = `https://scp-bb-bch02.southeastasia.cloudapp.azure.com:8888/api/v2/estimatefee/1`

export const walletExternal_config = {
